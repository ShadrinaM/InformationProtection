namespace PR1
{
    partial class GAKP
    {
        ...
        private void InitializeComponent()
        {
            ...
            numericUpDownN.Maximum = new decimal(new int[] { 10, 0, 0, 0 });
            ...
            numericUpDownB.Maximum = new decimal(new int[] { 256, 0, 0, 0 });
            ...
            numericUpDownB.Value = new decimal(new int[] { 10, 0, 0, 0 });
            // 
            // btnGenerateSeq
            // 
            ...
            label2.TabIndex = 14;
            label2.Text = "Сверхвозрастающая последовательность (A):";
            // 
            // label3
            // 
            ...
            Text = "Алгоритм классического обобщённого аддитивного рюкзака (GAKP)";
